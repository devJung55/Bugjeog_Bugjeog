...
<h3>6-4. 총평</h3>
배운 내용을 정확히 익혀 적용하는 적극적인 실습 활동으로 지식을 심화해야 한다고 생각했습니다. 올해 서울시에서 주관하는 '2023 서울 열린데이터광장' 웹 개발 부문 대회에서 기획과 코딩 부분을 맡았습니다. 5명이 한 팀이 되어 협업 툴인 Slack과 Figma를 통해 아이디를 도출하고 기획부터 개발까지의 팀원들과 협업하여 프로젝트 완료하였습니다. 하지만 아쉽게도 서울시 열린데이터광장에서 수상은 하지 못하였지만 저는 이 대회를 통해 배운 개발 내용들이 이론 및 기술을 더욱 견고하게 다져, 의미 있는 실습 활동으로 생각합니다.


이러한 경험들은 제 개발 역량을 향상시키고 실무에서 회사 코드를 분석하고 업무에 대해 이해하는 것에 큰 도움이 되었을 것이라고 생각합니다.
