...
const createFreeBoardDOM = function (board) {
    ...
    text += `</div>
                            ...
                            `
                                if(board.memberId){
                          text += ` <span>${board.memberName}</span>`;
                                }else {
                          text += ` <span>${board.businessCompanyName}</span>`;
                                }
            ...
            text+=          `        </div>
                            ...
                            <button type="button">
                                <svg style="background: none; cursor: pointer;" width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                    ...
                                    <path class="book-mark" d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="blue" fill-opacity="0.25"></path>
                                </svg>
                            </button>
                        </div>
                    </div>
